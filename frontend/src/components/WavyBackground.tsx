...
const WavyBackground = () => {
  return (
    <div className="absolute bottom-0 left-0 w-full h-60 sm:h-72 md:h-80 lg:h-96 pointer-events-none overflow-hidden z-0">
      {/* Container ensures SVG scales and animation runs smoothly */}
      {/* Apply horizontal slide animation to this container */}
      <div className="absolute bottom-0 left-0 w-[200%] h-full animate-wave-slide">
        ...
        <svg
          ...
          viewBox="0 0 1440 320" // Standard viewBox, adjust if needed
          preserveAspectRatio="none"
        >
          <path
            fill="currentColor" // Use text color for fill
            fillOpacity="1"
            // Example wave path - you can customize this shape
        ...
        <svg
          ...
          preserveAspectRatio="none"
          style={{ transform: 'translateX(10%) translateY(10px)' }} // Offset slightly
        >
          <path
            fill="currentColor"
            fillOpacity="1"
